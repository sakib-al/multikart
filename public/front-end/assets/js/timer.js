...
$(document).ready(function() {
    ...
    // var to_date = '<?php echo $shopview->discount_end ; ?>';
    // if (to_date) {
    //     // var countDownDate = new Date(to_date).getTime();
    //     var countDownDate = new Date(to_date).toDateString("MM DD, YYYY");
    //     console.log(to_date);
    //     // var countDownDate = new Date("Sep 5, 2021").getTime();
    // }else{
    // }
