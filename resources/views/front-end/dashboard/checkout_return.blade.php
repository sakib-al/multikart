            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="success-text">
                        ...
                        <p class="font-weight-bold">Order ID:- <b> #ORD-{{ $order->order_id }}</b></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-order">
                        @foreach ($info as $order_detail)
                        <div class="row product-order-detail">
                            <div class="col-3"><img src="{{asset('/')}}images/product/{{ $order_detail->product_image ?? 'no-image.jpg' }}" class="img-fluid blur-up lazyload"></div>
                            ...
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>quantity</h4>
                                    <h5>{{ $order_detail->product_qty }}</h5>
                                </div>
                            </div>
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>price</h4>
                                    <h5>{{ $order_detail->product_subtotal }}.00৳</h5>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="total-sec">
                            <ul>
                                <li>subtotal <span>{{ $order->product_subtotal }}.00৳</span></li>
                                <li>shipping <span>{{ $order->delivery_cost }}.00৳</span></li>
                            </ul>
                        </div>
                        <div class="final-total">
                            <h3>total <span>{{ $order->order_sum }}.00৳</span></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    <li>order ID: #ORD-{{ $order->order_id }}</li>
                                    <li>Order Date: {{ date('d M Y',strtotime($order->created_at)) }}</li>
                                    <li>Order Total: {{ $order->order_sum }}.00৳</li>
                                </ul>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    ...
                                    <li>{{ $order->from_city }}</li>
                                    <li>{{ $order->from_postcode }}, {{ $order->from_area }}.</li>
                                    <li>{{ $order->customer_address }}</li>
                                    <li>Contact No: {{ $order->customer_mobile }}</li>
                                </ul>
                            </div>
