                ...
                <div class="bg-warning card-body">
                    <div class="media static-top-widget row">
                        ...
                        <div class="media-body col-8"><span class="m-0">Total Transection</span>
                            <h3 class="mb-0">৳ <span class="counter">{{ $ordersum }}</span><small> This Month</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-secondary card-body">
                    <div class="media static-top-widget row">
                        ...
                        <div class="media-body col-8"><span class="m-0">Total Order</span>
                            <h3 class="mb-0"><span class="counter">{{ $totalorder }}</span><small> This Month</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-primary card-body">
                    <div class="media static-top-widget row">
                        ...
                        <div class="media-body col-8"><span class="m-0">Total Products</span>
                            <h3 class="mb-0"><span class="counter">{{ $totalprd }}</span><small> This Month</small></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden widget-cards">
                <div class="bg-danger card-body">
                    <div class="media static-top-widget row">
                        ...
                        <div class="media-body col-8"><span class="m-0">Total Customer</span>
                            <h3 class="mb-0"><span class="counter">{{ $totalcustomer }}</span><small> This Month</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="user-status table-responsive latest-order-table">
                        <table class="table table-bordernone">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{ route('order.view',[$order_list->id]) }}">#ORD-{{ $order_list->order_id }}</a></td>
                                    <td class="digits">{{ $order_list->order_sum }}.00৳</td>
            ...
            <div class="card">
                ...
                <div class="card-body sell-graph">
                    ...
                    <div class="code-box-copy">
                        ...
                        <pre class=" language-html"><code class=" language-html" id="example-head3">&lt;div class="card-body sell-graph"&gt;&lt;canvas id="myGraph"&gt;&lt;/canvas&gt; &lt;/div&gt;</code></pre>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('back-end/assets/images/dashboard/user2.jpg') }}" alt="" data-original-title="" title="">
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('back-end/assets/images/dashboard/user1.jpg') }}" alt="" data-original-title="" title="">
                                            <div class="d-inline-block">
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('back-end/assets/images/dashboard/man.png') }}" alt="" data-original-title="" title="">
                                            <div class="d-inline-block">
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('back-end/assets/images/dashboard/user.png') }}" alt="" data-original-title="" title="">
                                            <div class="d-inline-block">
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('back-end/assets/images/dashboard/designer.jpg') }}" alt="" data-original-title="" title="">
                                            <div class="d-inline-block">
