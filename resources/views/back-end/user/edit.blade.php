...
@section('master_title')Multikart - Users | Edit @endsection
@section('page_title')Edit Users @endsection
...
<div class="container-fluid">
    <div class="row product-adding">
        {!! Form::open([ 'class' => 'col-xl-12', 'route' => ['user.update',$user->id], 'method' => 'post', 'id' => 'quickForm', 'files' => true]) !!}
         @csrf
                        ...
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="validationCustom01" value="{{ $user->name }}" name="user_name" type="text" required="">
                                </div>
                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>User Email</label>
                                    <input class="form-control" id="validationCustomtitle" value="{{ $user->email }}" name="user_email" type="text" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0">Change Password</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                        <label class="d-block" for="edo-ani"><input class="radio_animated" id="edo-ani" type="radio" name="user_status"
                                            value="1"{{($user->user_status==1)?"checked":""}}>Enable</label>
                                        <label class="d-block" for="edo-ani1"><input class="radio_animated" id="edo-ani1" type="radio" name="user_status"
                                            value="0"{{($user->user_status==0)?"checked":""}}>Disable</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label"><span>*</span>User Role</label>
                                    {!! Form::select('user_roles', $role, $rolesid->role_id, ['class'=>'custom-select', 'id' => 'role', 'placeholder' => 'Select User Role', 'required']) !!}
                                </div>
