...
@section('page_title')Add Contact Us @endsection
...
<div class="container-fluid">
    <div class="row product-adding">
        {!! Form::open([ 'class' => 'col-xl-12', 'route' => 'contact.store', 'method' => 'post', 'id' => 'quickForm', 'files' => true]) !!}
         @csrf
                        ...
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="validationCustom01" name="google_map" type="text" placeholder="Paste google map <iframe> code" required="">
                                </div>
                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Phone No 1</label>
                                    <input class="form-control" id="validationCustomtitle" name="phone_no_1" type="text" required="">
                                </div>
                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0">Phone No 2</label>
                                    <input class="form-control" id="validationCustomtitle" name="phone_no_2" type="text" >
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Contact Address</label>
                                    <input class="form-control" id="validationCustomtitle" name="contact_us_address" type="text" required="">
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Email Address 1</label>
                                    <input class="form-control" id="validationCustomtitle" name="email_address_1" type="text" required="">
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0">Email Address 2</label>
                                    <input class="form-control" id="validationCustomtitle" name="email_address_2" type="text" >
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Fax Address 1</label>
                                    <input class="form-control" id="validationCustomtitle" name="fax_address_1" type="text" required="">
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0">Fax Address 2</label>
                                    <input class="form-control" id="validationCustomtitle" name="fax_address_2" type="text" >
                                </div>
