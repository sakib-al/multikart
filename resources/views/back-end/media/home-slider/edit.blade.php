...
<div class="container-fluid">
    <div class="row product-adding">
        {!! Form::open([ 'class' => 'col-xl-12', 'route' => ['slider.update',$slide->id], 'method' => 'post', 'id' => 'quickForm', 'files' => true]) !!}
         @csrf
                        ...
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ $slide->name }}" id="validationCustom01" name="slide_name" type="text" required="">
                                </div>
                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Slider Title</label>
                                    <input class="form-control" value="{{ $slide->slide_title }}" id="validationCustomtitle" name="slide_title" type="text" required="">
                                </div>

                                <div class="form-group">
                                    <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Slider Subtitle</label>
                                    <input class="form-control" value="{{ $slide->slide_subtitle }}" id="validationCustomtitle" name="slide_subtitle" type="text" required="">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label"><span>*</span> Status</label>
                                    <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                        <label class="d-block" for="edo-ani"><input class="radio_animated" id="edo-ani" type="radio" name="status"
                                            value="1"{{($slide->status==1)?"checked":""}}>Enable</label>
                                        <label class="d-block" for="edo-ani1"><input class="radio_animated" id="edo-ani1" type="radio" name="status"
                                            value="0"{{($slide->status==0)?"checked":""}}>Disable</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    <div class="product-buttons text-center">
                                        ...
                                        <a href="{{ route('slider.index') }}" type="button" class="btn btn-light">Discard</a>
                                    </div>
                                </div>
                            </div>
                        </div>
