...
@section('master_title')Multikart - Category @endsection
@section('page_title')Category @endsection
@section('bread_title')Category @endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-primary" data-type="add-category" data-toggle="modal" data-original-title="test"data-target="#categoryModal">Add Category</button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title f-w-600" id="categoryHead">Add Physical Category</h5>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="needs-validation" action="{{ route('category.create') }}" method="POST" enctype="multipart/form-data" id="category-form">
                                            @csrf
                                            ...
                                            <div class="form">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control cat-name" id="validationCustom01" type="text" name="name" required>
                                                </div>

                                                <div class="form-group mb-1">
                                                    <label for="validationCustom02" class="mb-1">Category Image:</label>
                                                    <input class="form-control cat-image" id="validationCustom02" type="file" name="category_image">
                                                </div>
                            ...
                            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                <table class="jsgrid-table">
                                    <tr class="jsgrid-header-row">
                                        ...
                                        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Sub Category</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="jsgrid-row">
                                            ...
                                            <td class="jsgrid-cell" style="width: 100px;">
                                                @foreach ($item->subcategories_item as $subcategory)
                                                    {{ $subcategory->name ?? '' }},
                                                @endforeach
                                            </td>
                                            ...
                                            <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center"style="width: 50px;">
                                                <a href="#" class="jsgrid-button jsgrid-edit-button editCategoryModal" type="button" data-url="{{ route('category.update', [$item->id]) }}" data-category_name="{{$item->name}}" data-category_image={{ $item->image ?? ''}} data-cat_status={{ $item->status }} data-source_id="{{$item->id}}" data-type="edit" title="Edit" data-toggle="modal" data-original-title="test"data-target="#categoryModal"></a>
                                                <a href="{{ route('category.delete', $item->id) }}" class="jsgrid-button jsgrid-delete-button" type="button"title="Delete" onclick="return confirm('Are you sure you want to delete ?')">
                                            </td>
                                        </tr>
                                        @endforeach
