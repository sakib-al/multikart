                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            <div class="brand-logo">
                                <a href="{{ route('index') }}"> <img src="{{ asset('front-end/assets/images/icon/logo/13.png') }}"
                        ...
                        <div class="menu-right pull-right">
                            ...
                            <div class="top-header">
                                <ul class="header-dropdown">
                                    <li class="mobile-wishlist"><a href="{{ route('wishlist') }}">
                                        <img src="{{ asset('front-end/assets/images/jewellery/icon/heart.png') }}" alt=""> </a>
                                    </li>
                                        ...
                                        <ul class="onhover-show-div">
                                            ...
                                            @if (Route::has('login'))
                                                @auth
                                                    ...
                                                    @else
                                                    <li>
                                                        <a href="{{ route('login') }}" data-lng="es">Login</a>
                                                    </li>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <form action="search" method="get">
                                                                        <div class="form-group">
                                                                            <input type="text"  class="form-control" name="search" id="exampleInputPassword1" placeholder="Search a Product">
                                                                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>{{ $slide_image->slide_subtitle }}</h4>
                                        <h1>{{ $slide_image->slide_title }}</h1>
                                        <a href="{{ route('shop') }}" class="btn btn-solid">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-4 product-m no-arrow">
                        @foreach ($topproduct as $top)
                            ...
                            <div class="product-box">
                                <input id="product_id" type="hidden" value="{{ $top->id }}">
                                <input type="hidden" id="quantity" value="1">
                                <div class="img-wrapper">
                                    <div class="lable-block">
                                        @if (date("Y-m-d") <= $top->discount_end)
                                            @if ($top->discount_status == 1)
                                            <span class="lable3">-{{ $top->discount_value }}%</span>
                                            @endif
                                        @endif
                                        @if ($top->best_sell == 1)
                                    ...
                                    <div class="front">
                                        <a href="{{ route('shop.view',$top->url_slug) }}">
                                            <img src="{{asset('/')}}images/product/{{ $top->singleImage->name ?? 'no-image.jpg' }}" class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                    </div>

                                    <div class="cart-info cart-wrap">
                                        <button title="Add to cart"><i class="ti-shopping-cart add-to-cart" data-pk="{{ $top->id }}"></i></button>
                                        <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" data-id="{{ $top->id }}" aria-hidden="true"></i></a>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View"><i class="ti-search" data-id="{{ $top->id }}" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            ...
                            <div id="tab-4" class="tab-content active default">
                                <div class="no-slider row">
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="img-wrapper">
                                            <div class="lable-block">
                                                @if (date("Y-m-d") <= $new->discount_end)
                                                    @if ($new->discount_status == 1)
                                                    <span class="lable3">-{{ $new->discount_value }}%</span>
                                                    @endif
                                                @endif
                                                @if ($new->best_sell ==1)
                                                <span class="lable4">on sale</span>
                                            ...
                                            <div class="front">
                                                <a href="{{ route('shop.view',$new->url_slug) }}">
                                                    <img src="{{asset('/')}}images/product/{{ $new->singleImage->name ?? 'no-image.jpg' }}" class="img-fluid blur-up lazyload bg-img" alt="">
                                                </a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-bs-toggle="modal"  data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart add-to-cart" data-pk="{{ $new->id }}"></i></button>
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                                <button  data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View">
                                                    <i class="ti-search" data-id="{{ $new->id }}" aria-hidden="true"></i>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="product-detail">
                            ...
                            <div id="tab-5" class="tab-content">
                                <div class=" no-slider row">
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="img-wrapper">
                                            <div class="lable-block">
                                                @if (date("Y-m-d") <= $feature->discount_end)
                                                    @if ($feature->discount_status == 1)
                                                    <span class="lable3">-{{ $feature->discount_value }}%</span>
                                                    @endif
                                                @endif
                                                @if ($feature->best_sell ==1)
                                                <span class="lable4">on sale</span>
                                                @endif
                                            </div>
                                            <div class="front">
                                                <a href="{{ route('shop.view',$feature->url_slug) }}">
                                                    <img src="{{asset('/')}}images/product/{{ $feature->singleImage->name ?? 'no-image.jpg' }}" class="img-fluid blur-up lazyload bg-img" alt="">
                                                </a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart add-to-cart" data-pk="{{ $feature->id }}"></i></button>
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View"><i data-id="{{ $feature->id }}" class="ti-search" aria-hidden="true"></i></a>
                            ...
                            <div id="tab-6" class="tab-content">
                                <div class=" no-slider row">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block">
                                                @if (date("Y-m-d") <= $best->discount_end)
                                                    @if ($best->discount_status == 1)
                                                    <span class="lable3">-{{ $best->discount_value }}%</span>
                                                    @endif
                                                @endif
                                                @if ($best->best_sell ==1)
                                                <span class="lable4">on sale</span>
                                            ...
                                            <div class="front">
                                                <a href="{{ route('shop.view',$best->url_slug) }}">
                                                    <img src="{{asset('/')}}images/product/{{ $best->singleImage->name ?? 'no-image.jpg' }}" class="img-fluid blur-up lazyload bg-img" alt="">
                                                </a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart add-to-cart" data-pk="{{ $best->id }}"></i></button>
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View"><i data-id="{{ $best->id }}" class="ti-search" aria-hidden="true"></i></a>
                            ...
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="offer-content">
                                        <img src="{{ asset('front-end/assets/images/Offer-banner.png') }}" class="img-fluid blur-up lazyload" alt="">
